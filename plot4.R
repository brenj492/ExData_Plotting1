...
par(mfrow=c(2,2))
## create plots
plot(pdata$Date_Time, pdata$Global_active_power,    #plot1, top left
     type="l", 
     ylab="Global Active Power", 
     xlab=NA)
plot(pdata$Date_Time, pdata$Voltage,                #plot2, top right
     type="l", 
     ylab="Voltage", 
     xlab="datetime")
plot(pdata$Date_Time, pdata$Sub_metering_1,         #plot3, bottom left
     type="l",
     ylab="Energy sub metering",
     xlab=NA)
points(pdata$Date_Time, pdata$Sub_metering_2, type="l", col="red")
points(pdata$Date_Time, pdata$Sub_metering_3, type="l", col="blue")
legend("topright", 
       c("Sub_metering_1", "Sub_metering_2", "Sub_metering_3"), 
       lwd=1, col=c("black", "red", "blue"))
plot(pdata$Date_Time, pdata$Global_reactive_power,  #plot4, bottom right
     type="l", 
